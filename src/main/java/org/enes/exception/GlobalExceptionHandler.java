...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> randevuSistemiHandler(RandevuSistemiException randevuSistemiException){
        return new ResponseEntity<>(createErrorMessage(randevuSistemiException, randevuSistemiException.getErrorType()),
                randevuSistemiException.getErrorType().getHttpStatus());
    }
